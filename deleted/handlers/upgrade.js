...
var metrics = require("skynode-server").metrics;
...
var getCustomerByUser = denodeify(customer.getCustomerByUser).bind(customer);
var setCustomer = denodeify(customer.setCustomer).bind(customer);
var setProAccount = denodeify(models.user.setProAccount).bind(models.user);
